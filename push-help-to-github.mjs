...
const filepath = 'src/pages/help.tsx';
...
async function pushToGitHub() {
  try {
    ...
    if (!localContent.includes('AI Support')) {
      throw new Error('❌ Local file does not contain AI Support feature!');
    }
    console.log('✅ Verified: Local file contains AI Support with /api/chat/send');
    ...
    const updateResponse = await fetch(updateUrl, {
      ...
      body: JSON.stringify({
        message: 'Add AI Support feature to Help Center using /api/chat/send endpoint',
